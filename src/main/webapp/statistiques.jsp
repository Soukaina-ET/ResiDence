    ...
    <style>
        * {
        ...
        .stat-card:nth-child(3) {
            background: linear-gradient(white, white) padding-box,
            linear-gradient(135deg, #0ea5e9 0%, #0284c7 100%) border-box;
        }
        ...
        .stat-card:nth-child(2) .stat-header h3 i {
            color: #06b6d4;
        }

        .stat-card:nth-child(3) .stat-header h3 i {
            color: #0ea5e9;
        }

        .stat-card:nth-child(4) .stat-header h3 i {
            color: #8b5cf6;
        }
            ...
            <div class="summary-cards">
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        ...
                        <p class="summary-label">Actifs dans la résidence</p>
                    </div>
                </div>
                <div class="summary-card">
                    <div class="summary-icon">
                ...
                <div class="summary-card">
                    ...
                    <div class="summary-content">
                        <h4>Demandes Maintenance</h4>
                        <p class="summary-value" id="maintenanceActive">0</p>
                        <p class="summary-label">Interventions en cours</p>
                    </div>
                </div>
            </div>
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-header">
                        <h3><i class='bx bx-bed'></i> Statistiques Chambres</h3>
                    </div>
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        <h3><i class='bx bxs-user-detail'></i> Répartition Résidents</h3>
                    </div>
                    <div class="chart-wrapper">
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        <h3><i class='bx bx-credit-card'></i> État Paiements</h3>
                    </div>
                    <div class="chart-wrapper">
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        <h3><i class='bx bx-wrench'></i> Demandes Maintenance</h3>
                    </div>
                    <div class="chart-wrapper">
