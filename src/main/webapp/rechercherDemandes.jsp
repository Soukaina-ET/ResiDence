            ...
            <table border="1">
                ...
                <%
                    ...
                    try {
                        ...
                        String query = "SELECT id, nom, prenom, telephone, email, cne, carte_etudiante, date_demande FROM demandes_inscription WHERE id LIKE ? OR nom LIKE ? OR prenom LIKE ? OR email LIKE ? OR telephone LIKE ? OR cne LIKE ? OR carte_etudiante LIKE ? OR date_demande LIKE ?";
