...
<table class="student-table" id="chambreTable">
    ...
    <%
        ...
        String selectPaiements = "SELECT * FROM paiements";
    ...
    <tr>
        ...
        <td>
        <button class="open-modal-btn" onclick="openModal(<%= rs.getInt("id") %>)" title="Modifier">
            <ion-icon name="pencil-outline"></ion-icon>
        </button>
        </td>
        <td><a href="DeletePaiement?id=<%= rs.getInt("id") %>"><ion-icon name="trash-outline"></ion-icon></a></td>
        <td><a href="GenererRecu?id=<%= rs.getInt("id") %>">
